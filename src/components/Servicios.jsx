...
const SERVICIOS_FALLBACK = [
  { id: "impresion",   nombre: "Impresión Digital",         tag: "FULL COLOR / B/N", descripcion: "Desde 1 pieza sin mínimo. Color y B/N en bond, couché, opalina y más. Ideal para cortas tiradas o archivos con datos variables.",        desde_precio: "Desde $0.60/pieza", activo: true, orden: 1, requiere_archivo: true  },
